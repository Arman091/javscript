/**
 * step-1:  create new promise object using => let prom=new Promise(function(resolve,reject){
 *
 * })
 *
...
prom.then(() => { console.log("yes we are open") });
prom.catch(() => {
...
let promis = new Promise((resolve, reject) => {
    if (ingrd) {
        resolve("we are passing argument from resolve");
    }
    else {
